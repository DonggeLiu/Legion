...
{ int ioStatus__Status ;ioStatus__Status = __VERIFIER_nondet_int();
  int ioctl ;
int event ;event = __VERIFIER_nondet_int();
  int irp ;
int status ;status = __VERIFIER_nondet_int();
  int __cil_tmp10 ;
  int __cil_tmp11 ;
  int __cil_tmp12 ;
  int __cil_tmp13 ;
...
{ int deviceExtension__Active ;deviceExtension__Active = __VERIFIER_nondet_int();
int deviceExtension ;deviceExtension = __VERIFIER_nondet_int();
  int status ;
int srb ;srb = __VERIFIER_nondet_int();
int srb__Cdb ;srb__Cdb = __VERIFIER_nondet_int();
  int cdb ;
  int inquiryDataPtr ;
  int attempt ;
  int tmp ;
int deviceParameterHandle ;deviceParameterHandle = __VERIFIER_nondet_int();
  int keyValue ;
  {
  {
#line 140
...
int irpSp__Parameters__UsageNotification__Type ;irpSp__Parameters__UsageNotification__Type = __VERIFIER_nondet_int();
int deviceExtension__PagingPathCountEvent ;deviceExtension__PagingPathCountEvent = __VERIFIER_nondet_int();
int irpSp__Parameters__UsageNotification__InPath ;irpSp__Parameters__UsageNotification__InPath = __VERIFIER_nondet_int();
int deviceExtension__PagingPathCount ;deviceExtension__PagingPathCount = __VERIFIER_nondet_int();
...
int Irp__Tail__Overlay__CurrentStackLocation ;Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int();
int deviceExtension__TargetDeviceObject ;deviceExtension__TargetDeviceObject = __VERIFIER_nondet_int();
  int tmp ;
...
{ int deviceExtension__PlayActive ;deviceExtension__PlayActive = __VERIFIER_nondet_int();
int ioStatus__Status ;ioStatus__Status = __VERIFIER_nondet_int();
int currentBuffer__Header__AudioStatus ;currentBuffer__Header__AudioStatus = __VERIFIER_nondet_int();
int irp_CdAudioIsPlayActive ;irp_CdAudioIsPlayActive = __VERIFIER_nondet_int();
int event ;event = __VERIFIER_nondet_int();
int status ;status = __VERIFIER_nondet_int();
int currentBuffer ;currentBuffer = __VERIFIER_nondet_int();
  int returnValue ;
  long __cil_tmp10 ;
  int __cil_tmp11 ;
...
int srb__Cdb ;srb__Cdb = __VERIFIER_nondet_int();
int currentIrpStack__Parameters__DeviceIoControl__IoControlCode ;currentIrpStack__Parameters__DeviceIoControl__IoControlCode = __VERIFIER_nondet_int();
  int Irp__IoStatus__Information ;
int currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength ;currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength = __VERIFIER_nondet_int();
int currentIrpStack__Parameters__DeviceIoControl__InputBufferLength ;currentIrpStack__Parameters__DeviceIoControl__InputBufferLength = __VERIFIER_nondet_int();
  int srb__CdbLength ;
  int cdb__CDB10__OperationCode ;
  int srb__TimeOutValue ;
int sizeof__READ_CAPACITY_DATA ;sizeof__READ_CAPACITY_DATA = __VERIFIER_nondet_int();
int lastSession__LogicalBlockAddress ;lastSession__LogicalBlockAddress = __VERIFIER_nondet_int();
int cdaudioDataOut__FirstTrack ;cdaudioDataOut__FirstTrack = __VERIFIER_nondet_int();
int cdaudioDataOut__LastTrack ;cdaudioDataOut__LastTrack = __VERIFIER_nondet_int();
int sizeof__CDROM_TOC ;sizeof__CDROM_TOC = __VERIFIER_nondet_int();
int sizeof__SUB_Q_CURRENT_POSITION ;sizeof__SUB_Q_CURRENT_POSITION = __VERIFIER_nondet_int();
int userPtr__Format ;userPtr__Format = __VERIFIER_nondet_int();
int sizeof__CDROM_PLAY_AUDIO_MSF ;sizeof__CDROM_PLAY_AUDIO_MSF = __VERIFIER_nondet_int();
int inputBuffer__StartingM ;inputBuffer__StartingM = __VERIFIER_nondet_int();
int inputBuffer__EndingM ;inputBuffer__EndingM = __VERIFIER_nondet_int();
int inputBuffer__StartingS ;inputBuffer__StartingS = __VERIFIER_nondet_int();
int inputBuffer__EndingS ;inputBuffer__EndingS = __VERIFIER_nondet_int();
int inputBuffer__StartingF ;inputBuffer__StartingF = __VERIFIER_nondet_int();
int inputBuffer__EndingF ;inputBuffer__EndingF = __VERIFIER_nondet_int();
int cdb__PLAY_AUDIO_MSF__OperationCode ;cdb__PLAY_AUDIO_MSF__OperationCode = __VERIFIER_nondet_int();
int sizeof__CDROM_SEEK_AUDIO_MSF ;sizeof__CDROM_SEEK_AUDIO_MSF = __VERIFIER_nondet_int();
  int currentIrpStack ;
  int deviceExtension ;
  int cdaudioDataOut ;
int srb ;srb = __VERIFIER_nondet_int();
int lastSession ;lastSession = __VERIFIER_nondet_int();
  int cdb ;
  int status ;
int i ;i = __VERIFIER_nondet_int();
int bytesTransfered ;bytesTransfered = __VERIFIER_nondet_int();
int Toc ;Toc = __VERIFIER_nondet_int();
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  ...
  int tracksInBuffer ;
  int userPtr ;
int SubQPtr ;SubQPtr = __VERIFIER_nondet_int();
  int tmp___5 ;
  int tmp___6 ;
  int inputBuffer ;
  int inputBuffer___0 ;
...
int currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength ;currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength = __VERIFIER_nondet_int();
int currentIrpStack__Parameters__DeviceIoControl__InputBufferLength ;currentIrpStack__Parameters__DeviceIoControl__InputBufferLength = __VERIFIER_nondet_int();
int TrackData__0 ;TrackData__0 = __VERIFIER_nondet_int();
  int Irp__IoStatus__Information ;
  int srb__TimeOutValue ;
  int srb__CdbLength ;
int sizeof__CDROM_TOC ;sizeof__CDROM_TOC = __VERIFIER_nondet_int();
...
int sizeof__CDROM_PLAY_AUDIO_MSF ;sizeof__CDROM_PLAY_AUDIO_MSF = __VERIFIER_nondet_int();
int sizeof__CDROM_SEEK_AUDIO_MSF ;sizeof__CDROM_SEEK_AUDIO_MSF = __VERIFIER_nondet_int();
int deviceExtension__Paused ;deviceExtension__Paused = __VERIFIER_nondet_int();
  int deviceExtension__PlayActive ;
int sizeof__SUB_Q_CHANNEL_DATA ;sizeof__SUB_Q_CHANNEL_DATA = __VERIFIER_nondet_int();
int sizeof__SUB_Q_CURRENT_POSITION ;sizeof__SUB_Q_CURRENT_POSITION = __VERIFIER_nondet_int();
int deviceExtension ;deviceExtension = __VERIFIER_nondet_int();
int srb ;srb = __VERIFIER_nondet_int();
  int status ;
...
int SubQPtr ;SubQPtr = __VERIFIER_nondet_int();
int userPtr__Format ;userPtr__Format = __VERIFIER_nondet_int();
int SubQPtr___0 ;SubQPtr___0 = __VERIFIER_nondet_int();
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  int __cil_tmp35 ;
...
{ int index ;index = __VERIFIER_nondet_int();
...
{ int Irp__PendingReturned ;Irp__PendingReturned = __VERIFIER_nondet_int();
int Irp__AssociatedIrp__SystemBuffer ;Irp__AssociatedIrp__SystemBuffer = __VERIFIER_nondet_int();
...
int d ;d = __VERIFIER_nondet_int();
int status ;status = __VERIFIER_nondet_int();
int irp ;irp = __VERIFIER_nondet_int();
int we_should_unload ;we_should_unload = __VERIFIER_nondet_int();
