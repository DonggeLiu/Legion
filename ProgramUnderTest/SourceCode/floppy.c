...
{ int status ;
  int threadHandle; threadHandle = __VERIFIER_nondet_int() ;
  int DisketteExtension__PoweringDown; DisketteExtension__PoweringDown = __VERIFIER_nondet_int() ;
  int DisketteExtension__ThreadReferenceCount; DisketteExtension__ThreadReferenceCount = __VERIFIER_nondet_int() ;
  int DisketteExtension__FloppyThread; DisketteExtension__FloppyThread = __VERIFIER_nondet_int() ;
  int Irp__IoStatus__Status ;
  int Irp__IoStatus__Information ;
  int Irp__Tail__Overlay__CurrentStackLocation__Control ;
  int ObjAttributes;  ObjAttributes = __VERIFIER_nondet_int() ;
  int __cil_tmp12 ;
  int __cil_tmp13 ;
...
{ int DeviceObject__DeviceExtension; DeviceObject__DeviceExtension = __VERIFIER_nondet_int();
  int Irp__Tail__Overlay__CurrentStackLocation; Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int();
  int Irp__IoStatus__Information ;
  int Irp__IoStatus__Status ;
  int Irp__CurrentLocation;  Irp__CurrentLocation = __VERIFIER_nondet_int() ;
  int disketteExtension__IsRemoved;  disketteExtension__IsRemoved = __VERIFIER_nondet_int() ;
  int disketteExtension__IsStarted; disketteExtension__IsStarted = __VERIFIER_nondet_int() ;
  int disketteExtension__TargetObject; disketteExtension__TargetObject = __VERIFIER_nondet_int() ;
  int disketteExtension__HoldNewRequests ;
  int disketteExtension__FloppyThread; disketteExtension__FloppyThread = __VERIFIER_nondet_int() ;
  int disketteExtension__InterfaceString__Buffer; disketteExtension__InterfaceString__Buffer = __VERIFIER_nondet_int() ;
  int disketteExtension__InterfaceString; disketteExtension__InterfaceString = __VERIFIER_nondet_int() ;
  int disketteExtension__ArcName__Length; disketteExtension__ArcName__Length = __VERIFIER_nondet_int() ;
  int disketteExtension__ArcName; disketteExtension__ArcName = __VERIFIER_nondet_int() ;
  int irpSp__MinorFunction; irpSp__MinorFunction = __VERIFIER_nondet_int() ;
  int IoGetConfigurationInformation__FloppyCount; IoGetConfigurationInformation__FloppyCount = __VERIFIER_nondet_int() ;
  int irpSp ;
  int disketteExtension ;
  int ntStatus ;
  int doneEvent; doneEvent = __VERIFIER_nondet_int() ;
  int irpSp___0 ;
  int nextIrpSp ;
...
{ int DeviceObject__DeviceExtension; DeviceObject__DeviceExtension  = __VERIFIER_nondet_int() ;
  ...
  int disketteExtension__DriveType; disketteExtension__DriveType  = __VERIFIER_nondet_int() ;
  int disketteExtension__PerpendicularMode ;
  int disketteExtension__DeviceUnit ;
  int disketteExtension__DriveOnValue ;
  int disketteExtension__UnderlyingPDO; disketteExtension__UnderlyingPDO  = __VERIFIER_nondet_int() ;
  int disketteExtension__InterfaceString; disketteExtension__InterfaceString  = __VERIFIER_nondet_int() ;
  ...
  int pnpStatus ;
  int doneEvent; doneEvent  = __VERIFIER_nondet_int() ;
  int fdcInfo; fdcInfo  = __VERIFIER_nondet_int() ;
  int fdcInfo__BufferCount ;
  int fdcInfo__BufferSize ;
  int fdcInfo__MaxTransferSize; fdcInfo__MaxTransferSize  = __VERIFIER_nondet_int() ;
  int fdcInfo__AcpiBios; fdcInfo__AcpiBios  = __VERIFIER_nondet_int() ;
  int fdcInfo__AcpiFdiSupported; fdcInfo__AcpiFdiSupported  = __VERIFIER_nondet_int() ;
  int fdcInfo__PeripheralNumber; fdcInfo__PeripheralNumber  = __VERIFIER_nondet_int() ;
  int fdcInfo__BusType ;
  int fdcInfo__ControllerNumber; fdcInfo__ControllerNumber  = __VERIFIER_nondet_int() ;
  int fdcInfo__UnitNumber; fdcInfo__UnitNumber  = __VERIFIER_nondet_int() ;
  int fdcInfo__BusNumber; fdcInfo__BusNumber  = __VERIFIER_nondet_int() ;
  int Dc ;
  int Fp ;
  int disketteExtension ;
  int irpSp ;
  ...
  int irpSp__Context ;
  int InterfaceType ;
  int KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86; KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86  = __VERIFIER_nondet_int() ;
  long __cil_tmp42 ;
  int __cil_tmp43 ;
  int __cil_tmp44 ;
  int __cil_tmp45 ;
  int __cil_tmp46; __cil_tmp46  = __VERIFIER_nondet_int() ;
  int __cil_tmp47 ;
  int __cil_tmp48 ;
  int __cil_tmp49 ;
...
{ int ntStatus ;
  ...
  int irpStack ;
  int doneEvent; doneEvent  = __VERIFIER_nondet_int() ;
  int ioStatus; ioStatus  = __VERIFIER_nondet_int() ;
  int irp__Tail__Overlay__CurrentStackLocation; irp__Tail__Overlay__CurrentStackLocation  = __VERIFIER_nondet_int() ;
...
int main(void) 
{ int status ;
  int irp; irp = __VERIFIER_nondet_int() ;
  int pirp ;
  int pirp__IoStatus__Status ;
  int irp_choice; irp_choice = __VERIFIER_nondet_int() ;
  int devobj; devobj = __VERIFIER_nondet_int() ;
  int __cil_tmp8 ;
...
{
  int malloc;  malloc = __VERIFIER_nondet_int() ;
...
int IofCallDriver(int DeviceObject , int Irp ) 
{
  int returnVal2 ;
  int compRetStatus1 ;
  int lcontext; lcontext = __VERIFIER_nondet_int() ;
...
{ int disketteExtension__HoldNewRequests; disketteExtension__HoldNewRequests  = __VERIFIER_nondet_int() ;
  int disketteExtension__IsRemoved; disketteExtension__IsRemoved = __VERIFIER_nondet_int() ;
  int Irp__IoStatus__Information ;
  int disketteExtension__IsStarted; disketteExtension__IsStarted = __VERIFIER_nondet_int() ;
  int Irp__CurrentLocation; Irp__CurrentLocation = __VERIFIER_nondet_int() ;
  int Irp__Tail__Overlay__CurrentStackLocation; Irp__Tail__Overlay__CurrentStackLocation = __VERIFIER_nondet_int() ;
  int disketteExtension__TargetObject; disketteExtension__TargetObject = __VERIFIER_nondet_int() ;
  int irpSp__Parameters__DeviceIoControl__OutputBufferLength; irpSp__Parameters__DeviceIoControl__OutputBufferLength = __VERIFIER_nondet_int() ;
  int sizeof__MOUNTDEV_NAME; sizeof__MOUNTDEV_NAME = __VERIFIER_nondet_int() ;
  int Irp__AssociatedIrp__SystemBuffer; Irp__AssociatedIrp__SystemBuffer = __VERIFIER_nondet_int() ;
  int mountName__NameLength ;
  int disketteExtension__DeviceName__Length; disketteExtension__DeviceName__Length = __VERIFIER_nondet_int() ;
  int sizeof__USHORT; sizeof__USHORT = __VERIFIER_nondet_int() ;
  int disketteExtension__InterfaceString__Buffer; disketteExtension__InterfaceString__Buffer = __VERIFIER_nondet_int() ;
  int uniqueId__UniqueIdLength ;
  int disketteExtension__InterfaceString__Length; disketteExtension__InterfaceString__Length = __VERIFIER_nondet_int() ;
  int sizeof__MOUNTDEV_UNIQUE_ID; sizeof__MOUNTDEV_UNIQUE_ID = __VERIFIER_nondet_int() ;
  int irpSp__Parameters__DeviceIoControl__InputBufferLength; irpSp__Parameters__DeviceIoControl__InputBufferLength = __VERIFIER_nondet_int() ;
  int sizeof__FORMAT_PARAMETERS; sizeof__FORMAT_PARAMETERS = __VERIFIER_nondet_int() ;
  int irpSp__Parameters__DeviceIoControl__IoControlCode___1; irpSp__Parameters__DeviceIoControl__IoControlCode___1 = __VERIFIER_nondet_int() ;
  int sizeof__FORMAT_EX_PARAMETERS; sizeof__FORMAT_EX_PARAMETERS = __VERIFIER_nondet_int() ;
  int formatExParameters__FormatGapLength; formatExParameters__FormatGapLength = __VERIFIER_nondet_int() ;
  int formatExParameters__SectorsPerTrack; formatExParameters__SectorsPerTrack = __VERIFIER_nondet_int() ;
  int sizeof__DISK_GEOMETRY; sizeof__DISK_GEOMETRY = __VERIFIER_nondet_int() ;
  int Irp__IoStatus__Status___0 ;
  int disketteExtension; disketteExtension = __VERIFIER_nondet_int() ;
  int ntStatus ;
  int outputBufferLength ;
  int lowestDriveMediaType; lowestDriveMediaType = __VERIFIER_nondet_int() ;
  int highestDriveMediaType; highestDriveMediaType = __VERIFIER_nondet_int() ;
  int formatExParametersSize; formatExParametersSize = __VERIFIER_nondet_int() ;
  ...
  int __cil_tmp39 ;
  int __cil_tmp40 ;
  int __cil_tmp41; __cil_tmp41 = __VERIFIER_nondet_int() ;
  int __cil_tmp42 ;
  int __cil_tmp43 ;
  int __cil_tmp44; __cil_tmp44 = __VERIFIER_nondet_int() ;
  int __cil_tmp45; __cil_tmp45 = __VERIFIER_nondet_int() ;
  int __cil_tmp46 ;
  int __cil_tmp47 ;
  int __cil_tmp48 ;
  int __cil_tmp49 ;
  int __cil_tmp50; __cil_tmp50 = __VERIFIER_nondet_int() ;
  int __cil_tmp51 ;
  int __cil_tmp52 ;
  int __cil_tmp53 ;
  int __cil_tmp54 ;
  int __cil_tmp55; __cil_tmp55 = __VERIFIER_nondet_int() ;
  int __cil_tmp56 ;
  int __cil_tmp57 ;
  int __cil_tmp58 ;
  int __cil_tmp59 ;
  int __cil_tmp60; __cil_tmp60 = __VERIFIER_nondet_int() ;
  int __cil_tmp61 ;
  int __cil_tmp62 ;
  int __cil_tmp63 ;
  int __cil_tmp64 ;
  int __cil_tmp65; __cil_tmp65 = __VERIFIER_nondet_int() ;
  int __cil_tmp66; __cil_tmp66 = __VERIFIER_nondet_int() ;
  int __cil_tmp67 ;
  int __cil_tmp68 ;
  int __cil_tmp69; __cil_tmp69 = __VERIFIER_nondet_int() ;
  int __cil_tmp70 ;
  int __cil_tmp71 ;
  int __cil_tmp72; __cil_tmp72 = __VERIFIER_nondet_int() ;
  int __cil_tmp73 ;
  int __cil_tmp74 ;
  int __cil_tmp75; __cil_tmp75 = __VERIFIER_nondet_int() ;
  int __cil_tmp76 ;
  int __cil_tmp77 ;
  int __cil_tmp78; __cil_tmp78 = __VERIFIER_nondet_int() ;
  int __cil_tmp79 ;
  int __cil_tmp80 ;
  int __cil_tmp81; __cil_tmp81 = __VERIFIER_nondet_int() ;
  int __cil_tmp82 ;
  int __cil_tmp83 ;
  int __cil_tmp84 ;
  int __cil_tmp85 ;
  int __cil_tmp86 ;
  int __cil_tmp87 ;
  int __cil_tmp88; __cil_tmp88 = __VERIFIER_nondet_int() ;
  int __cil_tmp89 ;
  int __cil_tmp90 ;
  long __cil_tmp91 ;
...
{ int DriveMediaConstants__driveMediaType__MediaType; DriveMediaConstants__driveMediaType__MediaType  = __VERIFIER_nondet_int() ;
  int FormatParameters__MediaType; FormatParameters__MediaType = __VERIFIER_nondet_int() ;
  int FAKE_CONDITION; FAKE_CONDITION = __VERIFIER_nondet_int() ;
