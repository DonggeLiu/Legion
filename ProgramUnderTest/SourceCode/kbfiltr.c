...
int irpStack__MinorFunction ;irpStack__MinorFunction==__VERIFIER_nondet_int();
int devExt__TopOfStack ;devExt__TopOfStack==__VERIFIER_nondet_int();
  int devExt__Started ;
  int devExt__Removed ;
...
{ int irpStack__MajorFunction ;irpStack__MajorFunction=__VERIFIER_nondet_int();
int devExt__UpperConnectData__ClassService ;devExt__UpperConnectData__ClassService=__VERIFIER_nondet_int();
  int Irp__IoStatus__Status ;
  int status ;
  int tmp ;
...
{ int Irp__Tail__Overlay__CurrentStackLocation ;Irp__Tail__Overlay__CurrentStackLocation=__VERIFIER_nondet_int();
int Irp__CurrentLocation ;Irp__CurrentLocation=__VERIFIER_nondet_int();
int DeviceObject__DeviceExtension__TopOfStack ;DeviceObject__DeviceExtension__TopOfStack=__VERIFIER_nondet_int();
  int irpStack ;
  int tmp ;
...
int powerState__DeviceState ;powerState__DeviceState=__VERIFIER_nondet_int();
int Irp__CurrentLocation ;Irp__CurrentLocation=__VERIFIER_nondet_int();
int Irp__Tail__Overlay__CurrentStackLocation ;Irp__Tail__Overlay__CurrentStackLocation=__VERIFIER_nondet_int();
int devExt__TopOfStack ;devExt__TopOfStack=__VERIFIER_nondet_int();
int powerType ;powerType=__VERIFIER_nondet_int();
  int tmp ;
...
{ int Irp__IoStatus__Information ;
int irpStack__Parameters__DeviceIoControl__IoControlCode ;irpStack__Parameters__DeviceIoControl__IoControlCode=__VERIFIER_nondet_int();
int devExt__UpperConnectData__ClassService ;devExt__UpperConnectData__ClassService=__VERIFIER_nondet_int();
int irpStack__Parameters__DeviceIoControl__InputBufferLength ;irpStack__Parameters__DeviceIoControl__InputBufferLength=__VERIFIER_nondet_int();
int sizeof__CONNECT_DATA ;sizeof__CONNECT_DATA=__VERIFIER_nondet_int();
int irpStack__Parameters__DeviceIoControl__Type3InputBuffer ;irpStack__Parameters__DeviceIoControl__Type3InputBuffer=__VERIFIER_nondet_int();
int sizeof__INTERNAL_I8042_HOOK_KEYBOARD ;sizeof__INTERNAL_I8042_HOOK_KEYBOARD=__VERIFIER_nondet_int();
int hookKeyboard__InitializationRoutine ;hookKeyboard__InitializationRoutine=__VERIFIER_nondet_int();
int hookKeyboard__IsrRoutine ;hookKeyboard__IsrRoutine=__VERIFIER_nondet_int();
  int Irp__IoStatus__Status ;
  int hookKeyboard ;
  int connectData ;
  int status ;
  ...
  int __cil_tmp18 ;
  int __cil_tmp19 ;
int __cil_tmp20 ;__cil_tmp20=__VERIFIER_nondet_int();
  int __cil_tmp21 ;
  int __cil_tmp22 ;
  int __cil_tmp23 ;
int __cil_tmp24 ;__cil_tmp24=__VERIFIER_nondet_int();
  int __cil_tmp25 ;
  int __cil_tmp26 ;
  int __cil_tmp27 ;
int __cil_tmp28 ;__cil_tmp28=__VERIFIER_nondet_int();
int __cil_tmp29 ;__cil_tmp29=__VERIFIER_nondet_int();
  int __cil_tmp30 ;
  int __cil_tmp31 ;
int __cil_tmp32 ;__cil_tmp32=__VERIFIER_nondet_int();
  int __cil_tmp33 ;
  int __cil_tmp34 ;
int __cil_tmp35 ;__cil_tmp35=__VERIFIER_nondet_int();
  int __cil_tmp36 ;
  int __cil_tmp37 ;
int __cil_tmp38 ;__cil_tmp38=__VERIFIER_nondet_int();
  int __cil_tmp39 ;
  int __cil_tmp40 ;
